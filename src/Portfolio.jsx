          ...
          <div className="about-grid mx-auto w-full max-w-6xl px-5 py-16 sm:px-8 md:px-10 md:py-24">
            ...
            <div className="order-1 md:order-2">
              ...
              <h2 className="text-2xl font-extrabold sm:text-4xl">
                <SplitWords text="Six years of learning, one habit" stagger={70} />
              </h2>
              <Reveal delay={260}>
                <p className="mt-6 text-sm leading-loose sm:mt-8 sm:text-base" style={{ color: C.s600 }}>
                  I started with certifications rather than a straight line — NCC diplomas, then ITPEC — because each one
                  forced me to learn a fundamental properly instead of skipping ahead to the framework.
                </p>
              </Reveal>
              <Reveal delay={380}>
                <p className="mt-5 hidden text-sm leading-loose sm:block sm:text-base" style={{ color: C.s600 }}>
                  That habit stuck. At Frontiir I work on services where a dropped message or a slow query is something a
                  customer feels, so I care about the boring parts: retries, logging, migrations, and code someone else
                  can read at 2am.
                </p>
              </Reveal>
            </div>
